 ...
 *
 * @root: A pointer to the root node of the BST from which a node will be removed.
 * @node: A pointer to the current node in the BST.
 * @value: The value to be removed from the BST.
 *
 * Return: A pointer to the root node after the deletion.
 */
...
/**
 * inorder_successor - Returns the minimum value of a Binary Search Tree (BST).
 *
